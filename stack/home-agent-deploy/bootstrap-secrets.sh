...
binding_committer_password="$(hex_secret 32)"
identity_migration_password="$(hex_secret 32)"
identity_finalizer_password="$(hex_secret 32)"
...
install -d -m 0700 -o root -g root "$master/binding-committer"
write_new binding-committer/postgres_binding_committer_password "$binding_committer_password"
...
install -d -m 0700 -o root -g root "$master/identity-finalizer"
write_new identity-finalizer/postgres_identity_finalizer_password "$identity_finalizer_password"
...
write_new binding-committer/database_url_binding_committer "postgresql+psycopg://home_agent_binding_committer:${binding_committer_password}@postgres:5432/home_agent"
...
write_new identity-finalizer/database_url_identity_finalizer "postgresql+psycopg://home_agent_identity_finalizer:${identity_finalizer_password}@postgres:5432/home_agent"
