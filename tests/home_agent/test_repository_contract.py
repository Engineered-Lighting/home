...
class RepositoryBoundaryTests(unittest.TestCase):
    ...
    def test_bff_and_core_share_only_typed_web_contracts(self) -> None:
        ...
        self.assertIn("initiatives/${UUID_PATH}/claim", native_routes)
        self.assertNotIn("private-localities", browser_routes)
        self.assertIn("private-localities", native_routes)
    ...
    def test_agent_surface_uses_typed_descriptor_lifecycle_only(self) -> None:
        ...
        self.assertIn("initiatives()", client)
        self.assertIn("claimInitiative", client)
        self.assertIn("Private arrival greeting", panel)
        self.assertIn("shown once for this visit", panel)
        ...
        self.assertIn('native("native_agent_list_initiatives")', client)
        self.assertIn('native("native_agent_claim_initiative"', client)
        self.assertIn("privateLocalities()", client)
        self.assertIn("previewPrivateLocality", client)
        self.assertIn("confirmPrivateLocality", client)
        self.assertNotIn('request("/api/agent/v1/private-localities', client)
        self.assertIn("Private locality approval", panel)
        self.assertIn("Confirm this exact private locality", panel)
        self.assertIn("Does not create:", panel)
    ...
    def test_dedicated_deployment_keeps_authorities_unpublished(self) -> None:
        ...
        self.assertNotIn("backup-egress", postgres_block)
        self.assertIn(
    ...
    def test_backup_gate_cannot_impersonate_database_owner(self) -> None:
        ...
        self.assertIn("repo1-type=posix", pgbackrest)
        self.assertIn("repo1-path=/repository", pgbackrest)
        self.assertNotIn("repo1-sftp-", pgbackrest)
        ...
        self.assertIn("process-max=1", pgbackrest)
        ...
        self.assertIn('"process-max": "1"', preflight)
