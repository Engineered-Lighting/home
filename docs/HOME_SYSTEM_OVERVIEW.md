...
- **Time-of-day-aware brightness and color temperature.** A single circadian curve (Adaptive Lighting) handles color from 2000 K warm at night to 4000 K neutral at midday; the brightness layer (Living Lights) bakes a vacant-baseline schedule (50 % during the day, 20 % overnight, 8 % during a movie). See `docs/ADAPTIVE-LIGHTING-V131.md` before updating HACS or testing `take_over_control_mode: pause_changed`.
